...
get_header(); ?>
        ...
        <div id="selector-of-filter">
          <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top">
            ...
            <li class="ui-state-default active-option ui-corner-top right-option"><a href="resultados-de-los-torneos-por-carrera" title="Resultados por carrera">Resultados por carrera</a></li>
